...
--insert into db_example.user (id,first_name ,last_name,email,city,country,lat,lon)   values (5,'Nikola','Nikolovski','nikola@gmail.com','Novi Sad','Srbija',67.343,20.43)
